...
<Container>
   <Row className='mt-4'>
    ...
    <Card color='light' inverse>
        <CardHeader>
           <h3 className='text-center' color='warning'> Fill Information to Register !!</h3>
        </CardHeader>
        <CardBody>
            {/* creating a form */}
            ...
            <p className='text-center'>Already Have an Account?<span><NavLink to='/login'>SignIn</NavLink></span></p>
        </CardBody>
    </Card>
    </Col>
   </Row>
