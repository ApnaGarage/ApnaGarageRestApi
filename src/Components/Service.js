          ...
          <div className='col'>
            <div className ='card text-centre'>
              <div className='card-header'>
                ...
                <p className='fw-normal'>Vehicle breakdown!!! Frustrated and stuck in a middle of nowhere? Got no assistance nearby? Don’t panic. Think of your friend, Garage2Ghar to the rescue.</p>
                </div>
            </div>
